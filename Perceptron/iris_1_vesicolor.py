...
perceptron = Perceptron_x(iterations=100, activation_function=sgn_function, random_seed=42)
...
plt.title('3D Plot of Iris Dataset with Species Names in Legend and Versicolor Separation Plane')
plt.show()
