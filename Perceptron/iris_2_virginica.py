...
perceptron = Perceptron(iterations=1000, activation_function=sgn_function, random_seed=42)
...
plt.title('3D Plot of Iris Dataset with Virginica Separation Plane')
plt.show()
...
plt.title("Perceptron Training Virginica - Number of Errors over Iterations")
plt.show()